...
If using static compilation in your domain classes add this additional dependency to your build classpath and dependencies:

----
buildscript {
  dependencies {
    classpath "org.grails.plugins:elasticsearch-grails-compile-static:1.4.1"
  }
}
dependencies {
    ...
    compile "org.grails.plugins:elasticsearch:1.4.1"
    compile "org.grails.plugins:elasticsearch-grails-compile-static:1.4.1"
    ...
}
----

This allows one to now use the `@grails.plugins.elasticsearch.compiler.GrailsSearchableCompileStatic` annotation!
